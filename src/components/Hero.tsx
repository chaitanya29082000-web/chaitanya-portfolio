...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Scroll indicator */}
      <div className="relative z-10 hidden md:flex justify-center pb-2" aria-hidden="true">
        <a
          href="#about"
          className="inline-flex flex-col items-center gap-1 text-text-muted hover:text-accent transition-colors duration-200 animate-[fadeIn_0.8s_ease-out_1.5s_forwards] opacity-0"
          tabIndex={-1}
        >
